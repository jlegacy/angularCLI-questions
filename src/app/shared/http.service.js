System.register(["@angular/http", "@angular/core"], function (exports_1, context_1) {
    ...
    var http_1, http_2, core_1, HttpService;
    return {
        setters: [
            function (http_1_1) {
                http_1 = http_1_1;
        ...
        execute: function () {
            HttpService = (function () {
                ...
                HttpService.prototype.post = function (url, data) {
                    return this._http.post(url, data, { headers: this.headers }).map(function (res) { return res.json(); });
                };
                HttpService.prototype.put = function (url, data) {
                    return this._http.put(url, data, { headers: this.headers }).map(function (res) { return res.json(); });
                };
